...
var blacklist = {
    ...
    'osm-mapnik-german_style': true,    // 'OSM (German Style)'
    'osm-mapnik-black_and_white': true, // 'OSM (Standard Black & White)'
...
fs.writeFileSync('data/imagery.json',
    JSON.stringify({ dataImagery: imagery }, null, 4));
