...
export function actionMergePolygon(ids, newRelationId) {
    ...
    var action = function(graph) {
        ...
        // An array representing all the polygons that are part of the
        // multipolygon. Each element is itself an array of objects with an id
        // property, and has a locs property which is an array of the locations
        // forming the polygon.
    ...
    action.disabled = function(graph) {
        ...
        if (entities.other.length > 0 ||
            ...
            return 'not_eligible';
        if (!entities.multipolygon.every(
                function(r) { return r.isComplete(graph); }
            ))
