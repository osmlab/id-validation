...
/*
    ...
    * An `off` function is available that unbinds the drag's internal event
      handlers.
 */
...
export function behaviorDrag() {
    ...
    function dragstart() {
        ...
        var eventTarget = d3.event.target,
            ...
            origin_ = point(),
            started = false,
            selectEnable = d3_event_userSelectSuppress(
                touchId !== null ? 'drag-' + touchId : 'drag');

        d3.select(window)
            .on(touchId !== null ? 'touchmove.drag-' + touchId
                : 'mousemove.drag', dragmove)
            .on(touchId !== null ? 'touchend.drag-' + touchId : 'mouseup.drag',
                dragend, true);
        ...
        function dragend() {
            ...
            d3.select(window)
                .on(touchId !== null ? 'touchmove.drag-' + touchId
                    : 'mousemove.drag', null)
                .on(touchId !== null ? 'touchend.drag-' + touchId
                    : 'mouseup.drag', null);
