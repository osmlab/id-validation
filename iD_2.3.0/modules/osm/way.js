...
_.extend(osmWay.prototype, {
    ...
    // If this way is not closed, append the beginning node to the end of the
    // nodelist to close it.
    close: function() {
    ...
    // If this way is closed, remove any connector nodes from the end of the
    // nodelist to unclose it.
    unclose: function() {
    ...
    // Adds a node (id) in front of the node which is currently at position
    // index. If index is undefined, the node will be added to the end of the
    // way for linear ways, or just before the final connecting node for
    // circular ways.
    ...
    addNode: function(id, index) {
        ...
        // If this is a closed way, remove all connector nodes except the first
        // one (there may be duplicates) and adjust index if necessary..
        if (isClosed) {
        ...
        // If the way was closed before, append a connector node to keep it
        // closed..
    ...
    // Replaces the node which is currently at position index with the given
    // node (id).
    // Consecutive duplicates are eliminated including existing ones.
