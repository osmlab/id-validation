...
export function presetPreset(id, preset, fields) {
    ...
    preset.terms = function() {
        return preset.t('terms', {'default': ''}).toLowerCase().trim().split(
            /\s*,+\s*/);
    };
    ...
    preset.isFallback = function() {
        ...
        return tagCount === 0 ||
            (tagCount === 1 && preset.tags.hasOwnProperty('area'));
    };
    ...
    preset.applyTags = function(tags, geometry) {
        ...
        // This is necessary if the geometry is already an area (e.g. user drew
        // an area) AND any of:
        // 1. chosen preset could be either an area or a line
        //    (`barrier=city_wall`)
