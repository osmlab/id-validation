...
export function svgLayers(projection, context) {
    var dispatch = d3.dispatch('change'),
        ...
        layers = [
            ...
            { id: 'mapillary-images', layer: svgMapillaryImages(
                projection, context, dispatch) },
            { id: 'mapillary-signs',  layer: svgMapillarySigns(
                projection, context, dispatch) },
    ...
    function drawLayers(selection) {
        ...
        groups.enter()
            ...
            .attr(
                'class',
                function(d) { return 'data-layer data-layer-' + d.id; }
            ).merge(groups)
