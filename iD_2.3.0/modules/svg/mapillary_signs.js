...
export function svgMapillarySigns(projection, context, dispatch) {
    var throttledRedraw = _.throttle(
            function () { dispatch.call('change'); }, 1000),
        minZoom = 12,
    ...
    function update() {
        ...
        // offset by -16px to center signs on loc
        signs
            .merge(enter)
            .attr('x', function(d) { return projection(d.loc)[0] - 16; })
            .attr('y', function(d) { return projection(d.loc)[1] - 16; });
    }
