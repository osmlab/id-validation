...
export function uiEntityEditor(context) {
    ...
    function entityEditor(selection) {
        ...
        header.selectAll('.preset-reset')
            .on(
                'click',
                function() { dispatch.call('choose', this, activePreset); }
            );
        ...
        enter
            ...
            .call(
                tooltip().title(t('inspector.back_tooltip')).placement('bottom')
            ).append('div')
            .attr('class', 'label');
        ...
        enter
            ...
            .attr(
                'class',
                'inspector-border raw-member-editor inspector-inner'
            );
    ...
    function clean(o) {
        ...
        function cleanVal(k, v) {
            ...
            if (_.some(blacklist, function(s) { return k.indexOf(s) !== -1; }))
                return v;
            ...
            if (k.indexOf('website') !== -1 ||
                ...
                // strip LRM and other zero width chars
                cleaned = cleaned
                    .replace(/[\u200B-\u200F\uFEFF]/g, '');
            }
    ...
    entityEditor.preset = function(_) {
        ...
        if (_ !== activePreset) {
            activePreset = _;
            reference = uiTagReference(
                activePreset.reference(context.geometry(id)), context
            ).showing(false);
        }
        return entityEditor;
    };
