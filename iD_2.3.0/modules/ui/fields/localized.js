...
export function uiFieldLocalized(field, context) {
    ...
    function addNew() {
        ...
        var langExists = _.find(data,
                function(datum) { return datum.lang === defaultLang;});
    ...
    function render(selection, data) {
        ...
        innerWrap.attr('class', 'entry')
            .each(function() {
                ...
                wrap
                    ...
                    .attr(
                        'placeholder',
                        t('translate.localized_translation_language')
                    ).on('blur', changeLang)
        ...
        utilGetSetValue(entry.select('.localized-lang'), function(d) {
                var lang = _.find(dataWikipedia,
                        function(lang) { return lang[2] === d.lang; });
