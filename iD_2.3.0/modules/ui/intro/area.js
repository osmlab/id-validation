...
export function uiIntroArea(context, reveal) {
    ...
    function continuePlayground() {
        ...
        revealPlayground(
            playground,
            t(
                'intro.areas.continue_playground',
                { alt: uiCmd.display('\u2325') }
            ),
            { duration: 250 }
        );
    ...
    function clickAddField() {
        ...
        timeout(function() {
            ...
            // It's possible for the user to add a description in a previous
            // step..  If they did this already, just continue to next step.
