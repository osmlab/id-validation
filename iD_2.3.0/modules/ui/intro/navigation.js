...
export function uiIntroNavigation(context, reveal) {
    ...
    function dragMap() {
        ...
        timeout(function() {
            ...
            context.map().on('move.intro', function() {
                ...
                if (centerStart[0] !== centerNow[0] ||
                    centerStart[1] !== centerNow[1]) {
    ...
    function pointsLinesAreas() {
        ...
        context.map().on('drawn.intro', function() {
            reveal(
                '#surface',
                t('intro.navigation.points_lines_areas'),
                {
                    duration: 0,
                    buttonText: t('intro.ok'),
                    buttonCallback: onClick
        ...
        timeout(function() {
            ...
            timeout(function() {
                ...
                context.map().on('move.intro drawn.intro', function() {
                    ...
                    reveal(
                        box,
                        t('intro.navigation.click_townhall'),
                        { duration: 0 }
                    );
                });
    ...
    function selectedTownHall() {
        ...
        context.map().on('move.intro drawn.intro', function() {
            ...
            reveal(
                box,
                t('intro.navigation.selected_townhall'),
                {
                    duration: 0,
                    buttonText: t('intro.ok'),
                    buttonCallback: onClick
    ...
    function closeTownHall() {
        ...
        reveal(
            '.entity-editor-pane',
            t(
                'intro.navigation.close_townhall',
    ...
    function searchStreet() {
        ...
        if (msec) { reveal(null, null, { duration: 0 }); }
        // and user can see it
        context.map().zoom(19).centerEase(springStreet, msec);

        timeout(function() {
            reveal(
                '.search-header input',
                t(
                    'intro.navigation.search_street',
    ...
    function checkSearchResult() {
        ...
        var first = d3.select('.feature-list-item:nth-child(0n+2)'),
    ...
    function selectedStreet() {
        if (!context.hasEntity(springStreetEndId) ||
            !context.hasEntity(springStreetId)) {
            return searchStreet();
        }
        ...
        reveal(
            box,
            t(
                'intro.navigation.selected_street',
                { name: t('intro.graph.name.spring-street') }
            ),
            {
                duration: 600,
        ...
        context.on('enter.intro', function(mode) {
            ...
            var ids = context.selectedIDs();
            if (mode.id !== 'select' || !ids.length ||
                ids[0] !== springStreetId) {
