...
export function uiIntroPoint(context, reveal) {
    ...
    function addPoint() {
        ...
        timeout(function() {
            var tooltip = reveal(
                    'button.add-point',
                    t(
                        'intro.points.add_point',
                        { button: icon('#icon-point', 'pre-text') }
                    )
                );
    ...
    function searchPreset() {
        if (context.mode().id !== 'select' || !pointId ||
            !context.hasEntity(pointId)) {
            return addPoint();
        }
    ...
    function enterDelete() {
        ...
        context.on('exit.intro', function() {
            ...
            var entity = context.hasEntity(pointId);
            if (entity)
                return continueTo(rightClickPoint);  // point still exists
        });
