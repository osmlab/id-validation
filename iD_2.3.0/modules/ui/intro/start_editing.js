...
export function uiIntroStartEditing(context, reveal) {
    ...
    function showHelp() {
        reveal(
            ...
            t(
                'intro.startediting.help',
                { button: icon('#icon-help', 'pre-text'), key: t('help.key') }
            ),
            {
    ...
    function shortcuts() {
        reveal(
            '.map-control.help-control',
            t(
                'intro.startediting.shortcuts',
                { key: t('shortcuts.toggle.key') }
            ),
            {
                buttonText: t('intro.ok'),
    ...
    function showSave() {
        // in case user opened keyboard shortcuts
