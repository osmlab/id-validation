...
export function uiShortcuts() {
    ...
    function render(selection) {
        ...
        var shortcutsEnter = shortcuts
            .enter()
            .append('div')
            .attr('class', function(d) { return 'shortcut-tab shortcut-tab-' +
                d.tab; });
        ...
        modifierKeys
            ...
            .data(function (d) {
                if (detected.os === 'win' &&
                    ...
                    return ['\u2318'];
                } else if (detected.os !== 'mac' && d.text ===
                        'shortcuts.browsing.display_options.fullscreen') {
                    return [];
                } else {
                    return d.modifiers;
                }
        ...
        shortcutKeys
            ...
            .each(function (d, i, nodes) {
                ...
                if (click && click[1]) {
                    selection.call(
                        svgIcon('#walkthrough-mouse', 'mouseclick', click[1]));
                } else {
                    selection
                        .append('kbd')
                        .attr('class', 'shortcut')
