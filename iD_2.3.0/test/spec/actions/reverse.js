describe('iD.actionReverse', function () {
    ...
    it('transforms multiple directional tags', function () {
        var way = iD.Way(
                {tags: {'maxspeed:forward': '25', 'maxspeed:backward': '30'}}),
            graph = iD.Graph([way]);

        graph = iD.actionReverse(way.id)(graph);
        expect(graph.entity(way.id).tags).to.eql(
            {'maxspeed:backward': '25', 'maxspeed:forward': '30'});
    });
        ...
        function () {
            var way = iD.Way({tags: {highway: 'residential'}}),
                relation = iD.Relation(
                    {members: [{type: 'way', id: way.id, role: 'forward'}]}),
                graph = iD.Graph([way, relation]);

            graph = iD.actionReverse(way.id)(graph);
            expect(graph.entity(relation.id).members[0].role)
                .to.eql('backward');
    ...
    it('transforms role=north \u27FA role=south in member relations',
        function () {
            var way = iD.Way({tags: {highway: 'residential'}}),
                relation = iD.Relation(
                    {members: [{type: 'way', id: way.id, role: 'north'}]}),
                graph = iD.Graph([way, relation]);
    ...
    it('transforms role=east \u27FA role=west in member relations',
        function () {
            var way = iD.Way({tags: {highway: 'residential'}}),
                relation = iD.Relation(
                    {members: [{type: 'way', id: way.id, role: 'east'}]}),
                graph = iD.Graph([way, relation]);
    ...
    it('reverses the direction of a forward facing stop sign on the way',
        function () {
            ...
            // Act - reverse the way
            var graph = iD.actionReverse(way.id)(
                iD.Graph([node1, node2, node3, way]));
            // Assert - confirm that the stop sign on node 2 has changed
            // direction
   ...
   it('reverses the direction of a left facing stop sign on the way',
        function () {
            ...
            var node2 = iD.Node();
            var node3 = iD.Node();
            // Attach a left facing stop sign to node 2 (not sure this is a real
            // situation, but allows us to test)
    ...
    it('reverses the direction of a right facing stop sign on the way',
        function () {
            ...
            var node2 = iD.Node();
            var node3 = iD.Node();
            // Attach a right facing stop sign to node 2 (not sure this is a
            // real situation, but allows us to test)
    ...
    it(
        'does not assign a direction to a directionless stop sign on ' +
            'the way during a reverse',
        function () {
            var node1 = iD.Node();
            var node2 = iD.Node();
            var node3 = iD.Node();
            ...
            var graph = iD.actionReverse(way.id)(
                iD.Graph([node1, node2, node3, way]));
            // Assert - confirm that the stop sign on node 2 has not gained a
            // direction tag
            var target = graph.entity(node2.id);
    ...
    it(
        'ignores directions other than forward or backward on attached ' +
            'stop sign during a reverse',
        function () {
            var node1 = iD.Node();
            var node2 = iD.Node();
            var node3 = iD.Node();
            ...
            var graph = iD.actionReverse(way.id)(
                iD.Graph([node1, node2, node3, way]));
            // Assert - confirm that the stop sign on node 2 has not had its
            // direction tag altered
            var target = graph.entity(node2.id);
    ...
    it('reverses the direction of a forward facing traffic sign on the way',
        function () {
            ...
            var node2 = iD.Node();
            var node3 = iD.Node();
            // Attach a forward facing stop sign to node 2 using the
            // traffic_sign approach
    ...
    it('reverses the direction of a backward facing stop sign on the way',
        function () {
            ...
            var node2 = iD.Node();
            var node3 = iD.Node();
           // Attach a backward facing stop sign to node 2 using the
           // traffic_sign approach
    ...
    it('reverses the direction of a left facing traffic sign on the way',
        function () {
            ...
            var node2 = iD.Node();
            var node3 = iD.Node();
            // Attach a left facing stop sign to node 2 using the traffic_sign
            // approach
    ...
    it('reverses the direction of a right facing stop sign on the way',
        function () {
            ...
            var node2 = iD.Node();
            var node3 = iD.Node();
            // Attach a right facing stop sign to node 2 using the traffic_sign
            // approach
