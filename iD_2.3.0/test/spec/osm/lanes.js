describe('iD.Lanes', function() {
    ...
    describe('default lane tags', function() {
        ...
        describe('motorway', function() {
            ...
            it('returns 2 lanes for highway=motorway', function() {
                expect(iD.Way({tags: { highway: 'motorway' }}).lanes()
                    .metadata.count, 'motorway lanes')
                    .to.eql(2);
                expect(iD.Way({tags: { highway: 'motorway', oneway: 'yes' }})
                    .lanes().metadata.count, 'motorway lanes')
                    .to.eql(2);
            });
            ...
            it('returns 1 lane for highway=motorway_link', function() {
                expect(iD.Way({tags: { highway: 'motorway_link' }}).lanes()
                    .metadata.count, 'motorway_link lanes')
                    .to.eql(1);
                expect(
                    iD.Way(
                        {tags: { highway: 'motorway_link', oneway: 'yes' }}
                    ).lanes().metadata.count, 'motorway_link lanes')
                    .to.eql(1);
            });

            it('returns 2 lanes for highway=motorway_link and oneway=no',
                function() {
                    expect(
                        iD.Way(
                          {tags: { highway: 'motorway_link', oneway: 'no' }}
                        ).lanes()
                        .metadata.count,
                        'motorway_link lanes'
                    ).to.eql(2);
        ...
        describe('trunk', function() {
            ...
            it('returns 4 lanes for highway=trunk', function() {
                expect(iD.Way({tags: { highway: 'trunk' }}).lanes()
                    .metadata.count, 'trunk lanes')
                    .to.eql(4);
                expect(iD.Way({tags: { highway: 'trunk', oneway: 'no' }})
                    .lanes().metadata.count, 'trunk lanes')
                    .to.eql(4);
            });

            it('returns 2 lanes for highway=trunk and oneway=yes', function() {
                expect(iD.Way({tags: { highway: 'trunk', oneway: 'yes' }})
                    .lanes().metadata.count, 'trunk lanes')
                    .to.eql(2);
            });

            it('returns 2 lanes for highway=trunk_link', function() {
                expect(iD.Way({tags: { highway: 'trunk_link' }}).lanes()
                    .metadata.count, 'trunk_link lanes')
                    .to.eql(2);
                expect(iD.Way({tags: { highway: 'trunk_link', oneway: 'no' }})
                    .lanes().metadata.count, 'trunk_link lanes')
                    .to.eql(2);
            });

            it('returns 1 lane for highway=trunk_link and oneway=yes',
                function() {
                    expect(
                        iD.Way({tags: { highway: 'trunk_link', oneway: 'yes' }})
                            .lanes().metadata.count,
                        'trunk_link lanes'
                    ).to.eql(1);
                }
            );
        ...
        describe('primary', function() {
            ...
            it('returns 2 lanes for highway=primary', function() {
                expect(iD.Way({tags: { highway: 'primary' }}).lanes()
                    .metadata.count, 'primary lanes')
                    .to.eql(2);
                expect(iD.Way({tags: { highway: 'primary', oneway: 'no' }})
                    .lanes().metadata.count, 'primary lanes')
                    .to.eql(2);
            });

            it('returns 1 lane for highway=primary and oneway=yes', function() {
                expect(iD.Way({tags: { highway: 'primary', oneway: 'yes' }})
                    .lanes().metadata.count, 'primary lanes')
                    .to.eql(1);
            });

            it('returns 2 lanes for highway=primary_link', function() {
                expect(iD.Way({tags: { highway: 'primary_link' }}).lanes()
                    .metadata.count, 'primary lanes')
                    .to.eql(2);
                expect(iD.Way({tags: { highway: 'primary_link', oneway: 'no' }})
                    .lanes().metadata.count, 'primary lanes')
                    .to.eql(2);
            });

            it('returns 1 lane for highway=primary_link and oneway=yes',
                function() {
                    expect(
                        iD.Way(
        ...
        describe('seconday', function() {
            ...
            it('returns 2 lanes for highway=secondary', function() {
                expect(iD.Way({tags: { highway: 'secondary' }})
                    .lanes().metadata.count, 'secondary lanes')
                    .to.eql(2);
                expect(iD.Way({tags: { highway: 'secondary', oneway: 'no' }})
                    .lanes().metadata.count, 'secondary lanes')
                    .to.eql(2);
            });

            it('returns 1 lane for highway=secondary and oneway=yes',
                function() {
                    expect(
                        iD.Way({tags: { highway: 'secondary', oneway: 'yes' }})
                        .lanes().metadata.count,
                        'secondary lanes'
                    ).to.eql(1);
                }
            ...
            it('returns 2 lane for highway=secondary_link', function() {
                expect(iD.Way({tags: { highway: 'secondary_link' }})
                    .lanes().metadata.count, 'secondary_link lanes')
                    .to.eql(2);
                expect(
                    iD.Way({tags: { highway: 'secondary_link', oneway: 'no' }})
                    .lanes().metadata.count,
                    'secondary_link lanes'
                ).to.eql(2);
            });

            it('returns 1 lane for highway=secondary_link and oneway=yes',
                function() {
                    expect(
                        iD.Way(
                            {tags: { highway: 'secondary_link', oneway: 'yes' }}
                        ).lanes().metadata.count,
                        'secondary_link lanes'
                    ).to.eql(1);
            });
        ...
        describe('tertiary', function() {
            ...
            it('returns 2 lanes for highway=tertiary', function() {
                expect(iD.Way({tags: { highway: 'tertiary' }})
                    .lanes().metadata.count, 'tertiary lanes')
                    .to.eql(2);
                expect(iD.Way({tags: { highway: 'tertiary', oneway: 'no' }})
                    .lanes().metadata.count, 'tertiary lanes')
                    .to.eql(2);
            });

            it('returns 1 lane for highway=tertiary and oneway=yes', function(){
                expect(iD.Way({tags: { highway: 'tertiary', oneway: 'yes' }})
                    .lanes().metadata.count, 'tertiary lanes')
                    .to.eql(1);
            });

            it('returns 2 lane for highway=tertiary_link', function() {
                expect(iD.Way({tags: { highway: 'tertiary_link' }})
                    .lanes().metadata.count, 'tertiary_link lanes')
                    .to.eql(2);
                expect(iD.Way({tags: { highway: 'tertiary_link', oneway: 'no'}})
                    .lanes().metadata.count, 'tertiary_link lanes')
                    .to.eql(2);
            });

            it('returns 1 lane for highway=tertiary_link and oneway=yes',
                function() {
                    expect(
                        iD.Way(
        ...
        describe('residential', function() {
            ...
            it('returns 2 lanes for highway=residential', function() {
                expect(iD.Way({tags: { highway: 'residential' }})
                    .lanes().metadata.count, 'residential lanes')
                    .to.eql(2);
                expect(iD.Way({tags: { highway: 'residential', oneway: 'no' }})
                    .lanes().metadata.count, 'residential lanes')
                    .to.eql(2);
            });

            it('returns 1 lane for highway=residential and oneway=yes',
                function() {
                    expect(
                        iD.Way(
        ...
        describe('service', function() {
            ...
            it('returns 2 lanes for highway=service', function() {
                expect(iD.Way({tags: { highway: 'service' }})
                    .lanes().metadata.count, 'service lanes')
                    .to.eql(2);
                expect(iD.Way({tags: { highway: 'service', oneway: 'no' }})
                    .lanes().metadata.count, 'service lanes')
                    .to.eql(2);
            });

            it('returns 1 lane for highway=service and oneway=yes', function() {
                expect(iD.Way({tags: { highway: 'service', oneway: 'yes' }})
                    .lanes().metadata.count, 'service lanes')
                    .to.eql(1);
            });
        });
        ...
        describe('track', function() {
            ...
            it('returns 2 lanes for highway=track', function() {
                expect(iD.Way({tags: { highway: 'track' }})
                    .lanes().metadata.count, 'track lanes')
                    .to.eql(2);
                expect(iD.Way({tags: { highway: 'track', oneway: 'no' }})
                    .lanes().metadata.count, 'track lanes')
                    .to.eql(2);
            });

            it('returns 1 lane for highway=track and oneway=yes', function() {
                expect(iD.Way({tags: { highway: 'track', oneway: 'yes' }})
                    .lanes().metadata.count, 'track lanes')
                    .to.eql(1);
            });
        });
        ...
        describe('path', function() {
            ...
            it('returns 2 lanes for highway=path', function() {
                expect(iD.Way({tags: { highway: 'path' }})
                    .lanes().metadata.count, 'path lanes')
                    .to.eql(2);
                expect(iD.Way({tags: { highway: 'path', oneway: 'no' }})
                    .lanes().metadata.count, 'path lanes')
                    .to.eql(2);
            });

            it('returns 1 lane for highway=path and oneway=yes', function() {
                expect(iD.Way({tags: { highway: 'path', oneway: 'yes' }})
                    .lanes().metadata.count, 'path lanes')
                    .to.eql(1);
            });
        });
    ...
    describe('oneway tags', function() {
        it('returns correctly oneway when tagged as oneway', function() {
            expect(iD.Way({tags: { highway: 'residential', oneway: 'yes' }})
                .lanes().metadata.oneway, 'residential lanes')
                .to.be.true;
            expect(iD.Way({tags: { highway: 'residential', oneway: 'no' }})
                .lanes().metadata.oneway, 'residential lanes')
                .to.be.false;
    ...
    describe('lane direction', function() {
        ...
        it('returns correctly the lane:forward and lane:backward count',
            function() {
                expect(
                    iD.Way({
                        tags: {
        ...
        it('returns correctly forward count when oneway=yes', function() {
            expect(
                iD.Way({tags: { highway: 'trunk', lanes: 2, oneway: 'yes' }})
                .lanes().metadata,
                'trunk lanes'
            ).to.include({
                count: 2,
        ...
        it('returns correctly backward count the when oneway=-1', function() {
            expect(
                iD.Way({tags: { highway: 'primary', lanes: 4, oneway: '-1' }})
                .lanes().metadata,
                'primary lanes'
            ).to.include({
                count: 4,
        ...
        it('returns correctly forward count if only backward is supplied',
            function() {
                expect(
                    iD.Way({
                        tags: {
        ...
        it('returns correctly backward count if only forward is supplied',
            function() {
                expect(
                    iD.Way({
                        tags: {
        ...
        it(
            'returns correctly backward count if forward and both_ways are ' +
                'supplied',
            function() {
                expect(
                    iD.Way({
        ...
        it(
            'returns correctly forward count if backward and both_ways ' +
                'are supplied',
            function() {
                expect(
                    iD.Way({
        ...
        it('returns correctly when lane:both_ways is 0 or Not a Number',
            function() {
                expect(
                    iD.Way({
                        tags: {
    ...
    describe.skip('lanes array', function() {
      it('should have correct number of direction elements', function() {
        var lanes = iD.Way({tags: { highway: 'residential', lanes: 5,
              'lanes:forward': 2, 'lanes:both_ways': 0, 'lanes:backward': 3 }})
              .lanes().lanes;
      ...
      it('should have corrent number of direction elements', function() {
        var lanes = iD.Way({tags: { highway: 'residential', lanes: 5,
                'lanes:backward': 1, 'lanes:both_ways': 1 }}).lanes().lanes;
        var forward = lanes.filter(function(l) {
          return l.direction === 'forward';
        });
        var backward = lanes.filter(function(l) {
    ...
    describe('turn lanes', function() {
        ...
        it(
            'returns correctly when multiple values are present in a lane ' +
                'and oneway=yes',
            function() {
            var lanesData = iD.Way({
                tags: {
                    ...
                    lanes: 5,
                    oneway: 'yes',
                    'turn:lanes': 'slight_left;reverse;left|slight_left;' +
                        'left;through|through|none|through;right',
                }
            }).lanes();
        ...
        it(
            ...
            var lanesData = iD.Way({
                tags: {
                    ...
                    'lanes:forward': 3,
                    'lanes:backward': 2,
                    'turn:lanes:forward': 'slight_left;reverse;left|' +
                        'slight_left;left;through|through',
        ...
        it(
            'returns unknown for every invalid value in turn:lanes:forward ' +
                '& turn:lanes:backward',
            function() {
            var metadata = iD.Way({
                tags: {
        ...
        it.skip(
            'fills with [\'unknown\'] when given turn:lanes are less ' +
                'than lanes count',
            function() {
                var metadata = iD.Way({
                    tags: {
        ...
        it.skip(
            'fills with [\'unknown\'] when given turn:lanes:forward ' +
                'are less than lanes forward count',
            function() {
                var metadata = iD.Way({
                    tags: {
                        highway: 'tertiary',
            ...
            function() {
                var metadata = iD.Way({
                    tags: {
                        ...
                        oneway: 'yes',
                        'turn:lanes':
                            'through|through;slight_right|slight_right',
                    }
                }).lanes().metadata;
        ...
        it(
            'turnLanes.forward and turnLanes.backward are both undefined ' +
        ...
        it(
            'parses turnLane correctly when lanes:both_ways=1 & ' +
        ...
        it('parses correctly when turn:lanes= ||x', function() {
            ...
            expect(metadata.turnLanes.unspecified).to.deep.equal(
                [['none'], ['none'], ['through', 'slight_right']]);
        });
        ...
        it('parses correctly when turn:lanes:forward= ||x', function() {
            ...
            expect(metadata.turnLanes.forward).to.deep.equal(
                [['none'], ['none'], ['through', 'slight_right']]);
            expect(metadata.turnLanes.backward)
                .to.deep.equal([['none']]);
        });
        ...
        it('fills lanes.unspecified with key \'turnLane\' correctly',
            function() {
                ...
                var turnLanesUnspecified = lanes.unspecified
                        .map(function(l) { return l.turnLane; });
                expect(turnLanesUnspecified).to.deep.equal([
                    ['slight_left'], ['none'], ['through'],
                    ['through', 'slight_right'], ['slight_right']
                ]);
        ...
        it(
            'fills lanes.forward & lanes.backward with key \'turnLane\' ' +
                'correctly',
            function() {
                var lanes = iD.Way({
                    tags: {
                ...
                var turnLanesForward = lanes.forward.map(
                        function(l) { return l.turnLane; });
                var turnLanesBackward = lanes.backward.map(
                        function(l) { return l.turnLane; });
    ...
    describe('maxspeed:lanes', function() {
        ...
        it(
            'should parse correctly when some values maxspeed:lanes are ' +
                'implied by x||y notation',
            function() {
                var maxspeedLanes = iD.Way({
                    tags: {
                        highway: 'residential',
        ...
        it('should return none for each maxspeed:lanes which equals maxspeed',
            function() {
                var maxspeedLanes = iD.Way({
                    tags: {
                        highway: 'residential',
        ...
        it('fills lanes.unspecified with key \'maxspeed\' correctly',
            function() {
                var lanes = iD.Way({
                    tags: {
                        highway: 'residential',
        ...
        it('should parse bicycle:lanes:forward/backward correctly', function() {
            var lanes = iD.Way({
                tags: {
                    ...
                    'lanes:forward': 4,
                    'lanes:backward': 3,
                    'turn:lanes:forward': 'left;through|left;through|' +
