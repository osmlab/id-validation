describe('iD.presetIndex', function() {
    ...
    describe('#match', function() {
        ...
        it(
            'returns a collection containing presets matching a geometry ' +
                'and tags',
            function() {
    ...
    describe('#areaKeys', function() {
        ...
        it('blacklists key-values for presets with both area and line geometry',
            function() {
                iD.data.presets = testPresets;
                var presets = iD.Context().presets();
        ...
        it(
            'does not blacklist key-values for presets with neither area ' +
                'nor line geometry',
            function() {
                iD.data.presets = testPresets;
                var presets = iD.Context().presets();
    ...
    describe('expected matches', function() {
        ...
        it('prefers building to address', function() {
            iD.data.presets = savedPresets;
            var presets = iD.Context().presets(),
                way = iD.Way({ tags: { area: 'yes', building: 'yes',
