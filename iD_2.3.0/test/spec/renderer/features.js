describe('iD.Features', function() {
    ...
    describe('#gatherStats', function() {
        it('counts features', function() {
            var graph = iD.Graph([
                    iD.Node({id: 'point_bar', tags: {amenity: 'bar'},
                        version: 1}),
                    iD.Node({id: 'point_dock', tags: {waterway: 'dock'},
                        version: 1}),
                    iD.Node({id: 'point_rail_station',
                        tags: {railway: 'station'}, version: 1}),
                    iD.Node({id: 'point_generator', tags: {power: 'generator'},
                        version: 1}),
                    iD.Node({id: 'point_old_rail_station', tags:
                        {railway: 'station', disused: 'yes'}, version: 1}),
                    iD.Way({id: 'motorway', tags: {highway: 'motorway'},
                        version: 1}),
                    iD.Way({id: 'building_yes', tags: {area: 'yes',
                        amenity: 'school', building: 'yes'}, version: 1}),
                    iD.Way({id: 'boundary', tags: {boundary: 'administrative'},
                        version: 1}),
    ...
    describe('matching', function() {
        var graph = iD.Graph([
            ...
            iD.Node({id: 'point_rail_station', tags: {railway: 'station'},
                version: 1}),
            iD.Node({id: 'point_generator', tags: {power: 'generator'},
                version: 1}),
            iD.Node({id: 'point_old_rail_station', tags: {railway: 'station',
                disused: 'yes'}, version: 1}),

            // Traffic Roads
            iD.Way({id: 'motorway', tags: {highway: 'motorway'}, version: 1}),
            iD.Way({id: 'motorway_link', tags: {highway: 'motorway_link'},
                version: 1}),
            iD.Way({id: 'trunk', tags: {highway: 'trunk'}, version: 1}),
            iD.Way({id: 'trunk_link', tags: {highway: 'trunk_link'},
                version: 1}),
            iD.Way({id: 'primary', tags: {highway: 'primary'}, version: 1}),
            iD.Way({id: 'primary_link', tags: {highway: 'primary_link'},
                version: 1}),
            iD.Way({id: 'secondary', tags: {highway: 'secondary'}, version: 1}),
            iD.Way({id: 'secondary_link', tags: {highway: 'secondary_link'},
                version: 1}),
            iD.Way({id: 'tertiary', tags: {highway: 'tertiary'}, version: 1}),
            iD.Way({id: 'tertiary_link', tags: {highway: 'tertiary_link'},
                version: 1}),
            iD.Way({id: 'residential', tags: {highway: 'residential'},
                version: 1}),
            iD.Way({id: 'unclassified', tags: {highway: 'unclassified'},
                version: 1}),
            iD.Way({id: 'living_street', tags: {highway: 'living_street'},
                version: 1}),
            ...
            iD.Way({id: 'pedestrian', tags: {highway: 'pedestrian'},
                version: 1}),
            iD.Way({id: 'corridor', tags: {highway: 'corridor'}, version: 1}),

            // Buildings
            iD.Way({id: 'building_yes', tags: {area: 'yes', amenity: 'school',
                building: 'yes'}, version: 1}),
            iD.Way({id: 'building_no', tags: {area: 'yes', amenity: 'school',
                building: 'no'}, version: 1}),
            iD.Way({id: 'building_part', tags: { 'building:part': 'yes'},
                version: 1}),
            iD.Way({id: 'shelter', tags: {area: 'yes', amenity: 'shelter'},
                version: 1}),
            iD.Way({id: 'garage1', tags: {area: 'yes', amenity: 'parking',
                parking: 'multi-storey'}, version: 1}),
            iD.Way({id: 'garage2', tags: {area: 'yes', amenity: 'parking',
                parking: 'sheds'}, version: 1}),
            iD.Way({id: 'garage3', tags: {area: 'yes', amenity: 'parking',
                parking: 'carports'}, version: 1}),
            iD.Way({id: 'garage4', tags: {area: 'yes', amenity: 'parking',
                parking: 'garage_boxes'}, version: 1}),

            // Landuse
            iD.Way({id: 'forest', tags: {area: 'yes', landuse: 'forest'},
                version: 1}),
            iD.Way({id: 'scrub', tags: {area: 'yes', natural: 'scrub'},
                version: 1}),
            iD.Way({id: 'industrial', tags: {area: 'yes',
                landuse: 'industrial'}, version: 1}),
            iD.Way({id: 'parkinglot', tags: {area: 'yes', amenity: 'parking',
                parking: 'surface'}, version: 1}),
            ...
            // Water
            iD.Way({id: 'water', tags: {area: 'yes', natural: 'water'},
                version: 1}),
            iD.Way({id: 'coastline', tags: {natural: 'coastline'}, version: 1}),
            iD.Way({id: 'bay', tags: {area: 'yes', natural: 'bay'},
                version: 1}),
            iD.Way({id: 'pond', tags: {area: 'yes', landuse: 'pond'},
                version: 1}),
            iD.Way({id: 'basin', tags: {area: 'yes', landuse: 'basin'},
                version: 1}),
            iD.Way({id: 'reservoir', tags: {area: 'yes', landuse: 'reservoir'},
                version: 1}),
            iD.Way({id: 'salt_pond', tags: {area: 'yes', landuse: 'salt_pond'},
                version: 1}),
            iD.Way({id: 'river', tags: {waterway: 'river'}, version: 1}),

            // Rail
            iD.Way({id: 'railway', tags: {railway: 'rail'}, version: 1}),
            iD.Way({id: 'rail_landuse', tags: {area: 'yes',
                landuse: 'railway'}, version: 1}),
            iD.Way({id: 'rail_disused', tags: {railway: 'disused'},
                version: 1}),
            iD.Way({id: 'rail_streetcar', tags: {railway: 'tram',
                highway: 'residential'}, version: 1}),
            iD.Way({id: 'rail_trail', tags: {railway: 'disused',
                highway: 'cycleway'}, version: 1}),

            // Power
            iD.Way({id: 'power_line', tags: {power: 'line'}, version: 1}),

            // Past/Future
            iD.Way({id: 'motorway_construction', tags: {highway: 'construction',
                construction: 'motorway'}, version: 1}),
            iD.Way({id: 'cycleway_proposed', tags: {highway: 'proposed',
                proposed: 'cycleway'}, version: 1}),
            iD.Way({id: 'landuse_construction', tags: {area: 'yes',
                landuse: 'construction'}, version: 1}),
        ...
        function doMatch(ids) {
            _.each(ids, function(id) {
                ...
                expect(features.isHidden(entity, graph, geometry),
                    'doMatch: ' + id).to.be.true;
            });
        }
        ...
        it('matches landuse', function () {
            ...
            doMatch([
                ...
                // non-interesting members of landuse multipolygon
                'outer', 'inner1', 'inner2'
            ]);
            ...
            dontMatch([
                ...
                'motorway_construction', 'fence',
                // member of landuse multipolygon, but tagged as highway
                'inner3'
            ]);
        });
        ...
        it('matches rail', function () {
            ...
            dontMatch([
                // because rail also used as highway
                'rail_streetcar', 'rail_trail',
                'point_bar', 'motorway', 'service', 'path', 'building_yes',
        ...
        it('matches past/future', function () {
            ...
            doMatch([
                ...
                'motorway_construction', 'cycleway_proposed',
        ...
        it('matches others', function () {
            ...
            dontMatch([
                'point_bar', 'motorway', 'service', 'path', 'building_yes',
                'forest', 'boundary', 'water', 'railway', 'power_line',
                'motorway_construction', 'retail', 'outer', 'inner1',
                'inner2', 'inner3'
            ]);
        });
    });
    ...
    describe('hiding', function() {
        it('hides child vertices on a hidden way', function() {
            var a = iD.Node({id: 'a', version: 1}),
                ...
                w = iD.Way({id: 'w', nodes: [a.id, b.id],
                    tags: {highway: 'path'}, version: 1}),
        ...
        it(
            'hides uninteresting (e.g. untagged or "other") member ways ' +
                'on a hidden multipolygon relation',
            function() {
                var outer = iD.Way({id: 'outer',
                        tags: {area: 'yes', natural: 'wood'}, version: 1}),
                    inner1 = iD.Way({id: 'inner1', tags: {barrier: 'fence'},
                        version: 1}),
                    inner2 = iD.Way({id: 'inner2', version: 1}),
                    inner3 = iD.Way({id: 'inner3', tags: {highway:
                        'residential'}, version: 1}),
                    r = iD.Relation({
                        id: 'r',
                ...
                // #2548
                expect(features.isHidden(outer, graph, outer.geometry(graph)))
                    .to.be.true;
                expect(features.isHidden(inner1, graph, inner1.geometry(graph)))
                    .to.be.true;
                expect(features.isHidden(inner2, graph, inner2.geometry(graph)))
                    .to.be.true;
                expect(features.isHidden(inner3, graph, inner3.geometry(graph)))
                    .to.be.false;
        });
        ...
        it('doubles auto-hide threshold when doubling viewport size',
            function() {
                var graph = iD.Graph([]),
                    maxPoints = 400,
