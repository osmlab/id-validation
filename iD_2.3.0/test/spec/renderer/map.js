describe('iD.Map', function() {
    ...
    describe('cursors', function() {
        ...
        specify('points use select-point cursor in browse and select modes',
            function() {
        ...
        specify('vertices use select-vertex cursor in browse and select modes',
            function() {
                mode.attr('class', 'mode-browse');
        ...
        specify('lines use select-line cursor in browse and select modes',
            function() {
                mode.attr('class', 'mode-browse');
        ...
        specify('areas use select-area cursor in browse and select modes',
            function() {
                mode.attr('class', 'mode-browse');
        ...
        specify('midpoints use select-split cursor in browse and select modes',
            function() {
                mode.attr('class', 'mode-browse');
        ...
        specify('features use select-add cursor for adding to a selection',
            function() {
                mode.attr('class', 'mode-select');
        ...
        specify(
            'features use select-remove cursor for removing from ' +
                'a selection',
            function() {
                mode.attr('class', 'mode-select');
                behavior.attr('class', 'behavior-multiselect');
        ...
        specify('hovered ways use draw-connect-line cursor in draw modes',
            function() {
        ...
        specify('hovered vertices use draw-connect-vertex cursor in draw modes',
            function() {
                behavior.attr('class', 'behavior-hover');
